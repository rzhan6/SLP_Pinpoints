...
def parseArgs(if_redef=True):
	...
	# -- env settings
	parser.add_argument('--ds_fd', default='/mnt/DADES2/SLP',
	...
	parser.add_argument('--batch_size_pGPU', default=100, type=int, help='batch size per gpu')
	...
	parser.add_argument('--testset', default='SLP', #default SLP || demoSLP
...
def aug_opts(opts):
	...
	opts.SLP_fd = os.path.join(opts.ds_fd, 'SLP', opts.SLP_set) # SLP folder [danaLab|simLab] #TESTED WITH demoSLP local file
	#CHANGED
